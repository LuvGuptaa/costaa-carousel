...
function addHex(hex, hexHeight, hexWidth) {
  ...
  const hexPath = document.createElementNS(
  ...
  hexPath.setAttribute(
    "d",
    "M1.49733 110.64V30.2381L69.0719 1.62278L138.503 30.2484V110.63L69.0717 138.384L1.49733 110.64Z"
  );
